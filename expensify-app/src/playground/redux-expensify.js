    ...
    switch (action.type) {
        ...
        //return state.concat(action.expense)
             return state.map((expense) => {
                 console.log("idt",expense.id, action.id)
...
const expenseOne = store.dispatch(addExpense({description:'Rent', amount:20, createdAt: -21000}))
const expenseTwo =store.dispatch(addExpense({description:'Coffee', amount:40,  createdAt: -1000}))
//console.log(expenseOne)
//console.log(expenseTwo)
//
//store.dispatch(rmExpense({id: expenseTwo.expense.id}));
